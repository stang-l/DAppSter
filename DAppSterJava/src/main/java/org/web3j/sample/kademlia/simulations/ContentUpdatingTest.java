...
public class ContentUpdatingTest
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            JKademliaNode kad1 = new JKademliaNode("JoshuaK", new KademliaId("ASF45678947584567467"), 7575);
            System.out.println("Created Node Kad 1: " + kad1.getNode().getNodeId());
            JKademliaNode kad2 = new JKademliaNode("Crystal", new KademliaId("ASERTKJDHGVHERJHGFLK"), 7576);
            System.out.println("Created Node Kad 2: " + kad2.getNode().getNodeId());
            kad2.bootstrap(kad1.getNode());

            /* Lets create the content and share it */
            DHTContentImpl c = new DHTContentImpl(kad2.getOwnerId(), "Some tset Data");
            kad2.put(c);
            ...
            System.out.println("Owner id: " + c.getOwnerId());
            ...
            c.setData("Some New Data bzuigih");
            kad2.put(c);
